...
public class Player extends Entity {
    ...
    public void update() {
        ...
        // movements
        if (isMove) {
            if (keyControl.downPress || keyControl.upPress || keyControl.rightPress
                    || keyControl.leftPress) {
                if (keyControl.upPress) {
                    direction = "up";
                } else if (keyControl.downPress) {
                    direction = "down";
                } else if (keyControl.rightPress) {
                    direction = "right";
                } else {
                    direction = "left";
                }
